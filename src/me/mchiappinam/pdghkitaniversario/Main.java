	...
	int task;
	  ...
	  public void onDisable() {
		...
		private void kit(Player p) {
		    ...
		    p.getInventory().addItem(new ItemStack(Material.getMaterial(30478), 1));
		    p.getInventory().addItem(new ItemStack(Material.getMaterial(250), 1, (short) 5));
		    p.getInventory().addItem(new ItemStack(Material.getMaterial(250), 1, (short) 3));
		    p.getInventory().addItem(new ItemStack(Material.getMaterial(246), 1));
		    p.getInventory().addItem(new ItemStack(Material.getMaterial(30191), 64));
		    p.getInventory().addItem(new ItemStack(Material.getMaterial(30190), 16));
		    p.getInventory().addItem(new ItemStack(Material.getMaterial(30216), 64));
		    p.getInventory().addItem(new ItemStack(Material.getMaterial(30216), 64));
		    p.getInventory().addItem(new ItemStack(Material.getMaterial(30188), 64));
		    p.getInventory().addItem(new ItemStack(Material.getMaterial(30188), 64));
		...
		private void kitV(Player p) {
		    p.getInventory().addItem(new ItemStack(Material.GOLDEN_APPLE, 32, (short) 1));
		    p.getInventory().addItem(new ItemStack(Material.getMaterial(30478), 1));
		    p.getInventory().addItem(new ItemStack(Material.getMaterial(250), 3, (short) 5));
		    p.getInventory().addItem(new ItemStack(Material.getMaterial(250), 3, (short) 3));
		    p.getInventory().addItem(new ItemStack(Material.getMaterial(246), 3));
		    p.getInventory().addItem(new ItemStack(Material.getMaterial(30191), 64));
		    p.getInventory().addItem(new ItemStack(Material.getMaterial(30191), 64));
		    p.getInventory().addItem(new ItemStack(Material.getMaterial(30191), 64));
		    p.getInventory().addItem(new ItemStack(Material.getMaterial(30191), 64));
		    p.getInventory().addItem(new ItemStack(Material.getMaterial(30190), 64));
		    p.getInventory().addItem(new ItemStack(Material.getMaterial(30190), 64));
		    p.getInventory().addItem(new ItemStack(Material.getMaterial(30216), 64));
		    p.getInventory().addItem(new ItemStack(Material.getMaterial(30216), 64));
		    p.getInventory().addItem(new ItemStack(Material.getMaterial(30216), 64));
